...
import styles from './OrdenesdeservicioEditForm.module.css'

export function OrdenesdeservicioEditForm(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.put(`/api/ordenesdeserv/ordenesdeserv?id=${ordserv.id}`, {
        ...formData
      })
      onReload()
      onOpenEdit()
